...
<dict>
  ...
  <array>
    ...
    <dict><key>Weekday</key><integer>6</integer><key>Hour</key><integer>16</integer><key>Minute</key><integer>30</integer></dict>
...
echo "Installed $LABEL at 16:30 and 23:30 every weekday."
echo "Plist: $TARGET"
